...
### v2.1.0 (2025-10-01)
- **Major Version Change**: Restructured from production code debugging to production requirements learning
- **Changed**: Focus from debugging code errors to improving requirements through production feedback
- **Changed**: Learning signals from code fixes to requirements clarity/completeness
- **Changed**: Validation from code correctness to requirements-implementation alignment
- **Reduced**: From 1938 lines to ~900 lines (right-sizing)
